                ...
                <?php
                  if(is_array($blog) && count($blog)>0){
                    ...
                    foreach ($blog as $blog_v) {
                      ...
                      <tr>
                        <td><?=$i?></td>
                        <td><img src="<?=site_url('fassets/images/blog/'.$blog_v->image)?>" title="<?=$blog_v->title?>" width="100px" onerror="this.src='<?=site_url('assets/images/no-image.png');?>';"></td>
                        <td><?php if($blog_v->popular=='blog'){ echo"Blog";} elseif ($blog_v->popular=='news') { echo "News"; } elseif($blog_v->popular=='press'){ echo"Press";}elseif ($blog_v->popular=='inv_kit'){echo"Investor Kit";}?></td>
                        <td><?=$blog_v->title?></td>
